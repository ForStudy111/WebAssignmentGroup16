        ...
        <div class="dashboard-layout">
            <aside class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="<%= request.getContextPath()%>/UserServlet?action=list">Student List</a></li>
                    <li><a href="<%= request.getContextPath()%>/CounsellorServlet?action=list">Manage Counsellors</a></li>
                    <li><a class="active" href="<%= request.getContextPath()%>/BookingServlet?action=adminList">View Bookings</a></li>
                                ...
                                <% if (!bookingList.isEmpty()) {
                                        ...
                                        for (Booking booking : bookingList) {
                                            ...
                                            Counsellor counsellor = schedule != null
                                                    ? counsellorMap.get(schedule.getCounsellorId()) : null;
                                            ...
                                            if ("APPROVED".equalsIgnoreCase(status)) {
                                                ...
                                                statusText = cancelledBy != null && !cancelledBy.trim().isEmpty()
                                                        ? "Cancelled by " + cancelledBy : "Cancelled";
                                            } else {
                                                statusText = "Pending";
                                            }
                                %>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="danger-button"
                                           href="<%= request.getContextPath()%>/BookingServlet?action=cancel&id=<%= booking.getBookingId()%>"

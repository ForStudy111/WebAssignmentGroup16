        ...
        <div class="dashboard-layout">
            <aside class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="<%= request.getContextPath()%>/BookingServlet?action=counsellorList">Manage Bookings</a></li>
                    <li><a class="active" href="<%= request.getContextPath()%>/SessionRecordServlet?action=counsellorList">Session Records</a></li>
                                ...
                                <% if (!recordList.isEmpty()) {
                                        ...
                                        for (SessionRecord record : recordList) {
                                            ...
                                            User student = booking != null
                                                    ? studentMap.get(booking.getUserId()) : null;
                                %>
                                <tr>
                                    <td><%= rowNumber++%></td>
                                    <td><%= student != null ? student.getFullName() : "-"%></td>
                                    <td><%= schedule != null ? schedule.getAvailableDate()
                                        : record.getSessionDate()%></td>
                                    <td><%= schedule != null ? schedule.getAvailableTime() : "-"%></td>
                                    <td><%= record.getSessionNotes()%></td>
                                    <td><%= record.getFeedback() != null && !record.getFeedback().trim().isEmpty()
                                        ? record.getFeedback() : "No feedback yet"%></td>

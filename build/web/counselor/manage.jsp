        ...
        <div class="dashboard-layout">
            <aside class="sidebar">
                ...
                <ul class="sidebar-menu">
                    <li><a href="<%= request.getContextPath()%>/counselor/dashboard.jsp">Dashboard</a></li>
                    <li><a href="<%= request.getContextPath()%>/ScheduleServlet?action=list">Manage Availability</a></li>
                    <li><a class="active" href="<%= request.getContextPath()%>/BookingServlet?action=counsellorList">Manage Bookings</a></li>
                    <li><a href="<%= request.getContextPath()%>/SessionRecordServlet?action=counsellorList">Session Records</a></li>
                            ...
                            <tbody>
                                <% if (!bookingList.isEmpty()) {
                                        ...
                                        for (Booking booking : bookingList) {
                                            ...
                                            User student = studentMap.get(booking.getUserId());
                                            ...
                                            if ("APPROVED".equalsIgnoreCase(status)) {
                                                ...
                                                if (cancelledBy != null && !cancelledBy.trim().isEmpty()) {
                                                    ...
                                                    statusText = "CANCELLED BY " + cancelledBy;
                                                }
                                            }
                                %>
                                <tr>
                                    <td><%= rowNumber++%></td>
                                    <td><%= student != null ? student.getFullName() : "-"%></td>
                                    <td><%= student != null ? student.getEmail() : "-"%></td>
                                    <td><%= student != null && student.getPhoneNumber() != null
                                        ? student.getPhoneNumber() : "-"%></td>
                                    <td><%= schedule != null ? schedule.getAvailableDate() : "-"%></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="danger-button"
                                           href="<%= request.getContextPath()%>/BookingServlet?action=reject&id=<%= booking.getBookingId()%>"

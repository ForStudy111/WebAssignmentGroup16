...
public class UserServlet extends HttpServlet {
    ...
    private void showCreateUserForm(HttpServletRequest request,
            HttpServletResponse response,
            User currentUser)
            throws ServletException, IOException {
    ...
    private void showEditUserForm(HttpServletRequest request,
            HttpServletResponse response,
            User currentUser)
            throws ServletException, IOException {
    ...
    private void createUser(HttpServletRequest request,
        ...
        if (userDAO.addUser(user)) {
            ...
            redirectWithMessage(request, response,
                    "/UserServlet?action=new",
                    "User creation failed. The email may already exist.");
        }
    }

    private void updateUserByAdmin(HttpServletRequest request,
            HttpServletResponse response,
            User currentUser) throws IOException {
        ...
        if (userDAO.updateUser(user)) {
            ...
            redirectWithMessage(request, response,
                    "/UserServlet?action=edit&id=" + userId,
                    "User update failed. Username or email may already exist.");
        }
    }

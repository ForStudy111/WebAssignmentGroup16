...
public class CounsellorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CounsellorServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CounsellorServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    private void createCounsellor(HttpServletRequest request,
        ...
        if (counsellorDAO.createCounsellor(user, counsellor)) {
            ...
            redirectWithMessage(request, response,
                    "/CounsellorServlet?action=new",
                    "Counsellor creation failed. Username or email may already exist.");
        }
    }
    ...
    private void updateCounsellor(HttpServletRequest request,
        ...
        if (userUpdated && counsellorUpdated) {
            ...
            redirectWithMessage(request, response,
                    "/CounsellorServlet?action=edit&id=" + counsellorId,
                    "Counsellor update failed. Username or email may already exist.");
        }
    }
    ...
    private void deleteCounsellor(HttpServletRequest request,
        ...
        // Deleting the linked user triggers database cascade deletion
        // for the counsellor profile and related records.
    ...
    private void redirectToLogin(HttpServletRequest request,
        ...
        response.sendRedirect(request.getContextPath()
                ...
                + URLEncoder.encode("Please log in as an admin first.", "UTF-8"));
    }

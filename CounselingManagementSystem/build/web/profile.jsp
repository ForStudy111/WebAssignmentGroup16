...
<%
    ...
    String fullNameValue = currentUser.getFullName() != null
            ? currentUser.getFullName() : "";

    String emailValue = currentUser.getEmail() != null
            ? currentUser.getEmail() : "";

    String phoneValue = currentUser.getPhoneNumber() != null
        ...
        <div class="dashboard-layout">
            ...
            <aside class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="<%= request.getContextPath()%>/ChangePasswordServlet">
                            Change Password
                        </a>
                    </li>
